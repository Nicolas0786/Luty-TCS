...
let AlaService = class AlaService {
    constructor(repositorioAla) {
    ...
    update(idAla, updateAlaDto) {
        const ala = new ala_entity_1.Ala;
        ala.descricao = updateAlaDto.descricao;
        return this.repositorioAla.update(idAla, ala);
    }
};
AlaService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(ala_entity_1.Ala)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], AlaService);
exports.AlaService = AlaService;
//# sourceMappingURL=ala.service.js.map